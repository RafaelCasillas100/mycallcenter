...
$pro_url  = 'https://wow-estore.com/item/button-generator-pro/';
$demo_url = 'https://preview.wow-estore.com/button-generator-pro/';
?>
        ...
        <div class="columns is-multiline is-variable is-3 feature-boxes">
            ...
            <div class="column is-full-mobile is-one-quarter-desktop is-half-tablet ">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Hover Animation</p>
                        <p>You can set one of 70+ animations for a button when you hover over it. The animation can be set for the
                            whole button, for the icon and for the background color.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column is-full-mobile is-one-quarter-desktop is-half-tablet ">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Info Badge</p>
                        <p>Adds the ability to create an information badge for the button. When the notification badge is showing, the user can with more likely perform a click on the button to
                            reveal a pop-up dialog that displays the notifications that currently exist or redirect on the page with
                            notifications.</p>
                    </div>
                </div>
            </div>
